...
public class JedisTest2 {
    ...
    public static void main(String[] args) {  
        ...
        RedisUtil.getPool("127.0.0.1",6738).destroy();  
  
    }  
  
    public static void Hello() {  
        Jedis jedis = RedisUtil.getJedis("127.0.0.1",6738);
        try {  
            ...
            RedisUtil.getPool("127.0.0.1",6738).returnResource(jedis);  
        }  
    ...
    public void testSort1() {  
        ...
        Jedis redis = RedisUtil.getJedis("127.0.0.1",6738);
